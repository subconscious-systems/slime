...
CKPT_ARGS=(
   --hf-checkpoint ${BASE_FOLDER}/models/Qwen3-0.6B/
   --ref-load ${SLIME_DIR}/resource/Qwen3-0.6B_torch_dist
   --load ${SLIME_DIR}/ckpts/Qwen3-0.6B_slime-sft/
   --save ${SLIME_DIR}/ckpts/Qwen3-0.6B_slime-sft/
   --save-interval 1000
)
...
SFT_ARGS=(
   ...
   --prompt-data ${BASE_FOLDER}/inference/BeaverFactory/data/nemotron_swe_sft.parquet
   --input-key messages
   # --apply-chat-template
   --rollout-shuffle
   --num-epoch 2

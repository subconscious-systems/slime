...
CKPT_ARGS=(
   --hf-checkpoint ${BASE_FOLDER}/models/tim-0.6B-SFT/
   --ref-load ${SLIME_DIR}/resource/tim-0.6B-SFT_torch_dist
   --load ${SLIME_DIR}/ckpts/tim-0.6B_torch_dist_slime-rl/
   --save ${SLIME_DIR}/ckpts/tim-0.6B_torch_dist_slime-rl/
   --save-interval 300
)

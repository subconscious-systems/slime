...
CKPT_ARGS=(
   --hf-checkpoint ${BASE_FOLDER}/models/Qwen3.5-27B/
   --ref-load ${SLIME_DIR}/resource/Qwen3.5-27B_torch_dist
   --load ${SLIME_DIR}/ckpts/Qwen3.5-27B_slime-sft/
   --save ${SLIME_DIR}/ckpts/Qwen3.5-27B_slime-sft/
   --save-interval 1000
)
